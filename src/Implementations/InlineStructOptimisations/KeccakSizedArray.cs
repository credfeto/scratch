...
[SuppressMessage(
    ...
    checkId: "FFS0011",
    Justification = "Can't be read only for InlineArray"
)]
[InlineArray(Length)]
public struct KeccakSizedArray
{
    ...
    [SuppressMessage(
        ...
        Justification = "Required for InlineArray to work"
    )]
    [SuppressMessage(
        category: "SonarAnalyzer.CSharp",
        checkId: "S4487: Unused private property",
        Justification = "Required for InlineArray to work"
    )]
    [SuppressMessage(
        category: "ReSharper",
    ...
    [SuppressMessage(
        category: "ReSharper",
        checkId: "FieldCanBeMadeReadOnly.Local",
        Justification = "Required for InlineArray to work"
    )]
    [SuppressMessage(
        category: "VisualStudio",
        checkId: "IDE0044: FieldCanBeMadeReadOnly.Local",
        Justification = "Required for InlineArray to work"
    )]
