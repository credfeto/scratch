...
ALTER TABLE [sales].[staffs] ADD CONSTRAINT [FK__staffs__manager___31EC6D26] FOREIGN KEY ([manager_id]) REFERENCES [sales].
    [staffs] ([staff_id])
GO

ALTER TABLE [sales].[staffs] ADD CONSTRAINT [FK__staffs__store_id__30F848ED] FOREIGN KEY ([store_id]) REFERENCES [sales].
    [stores] ([store_id]) ON
